...
Router.register('tech-profile', {
  render() {
    ...
    const menuHtml = MENU.map((item) => `
      <div class="menu-item" onclick="${item.toggle && item.id !== 'darkMode' ? 'event.preventDefault()' : item.danger ? 'window.techProfLogout()' : 'window.techProfAction(\'' + item.label + '\')'}">
        <div class="menu-left">
      ...
      html: `
        <div class="screen">
          ...
          <div class="tech-profile-card">
            ...
            ${pincode ? `<div class="tech-profile-detail">📮 ${pincode}</div>` : ''}
