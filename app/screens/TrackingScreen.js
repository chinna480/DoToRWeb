    ...
    <View style={{ flex: 1, backgroundColor: '#f5f5f5' }}>
      ...
      {techLat ? (
        <View style={s.mapPlaceholder}>
          <Text style={s.mapBig}>🗺️</Text>
          <Text style={s.mapStatus}>🛵 Technician is {distance} away</Text>
          <Text style={s.mapEta}>ETA: {eta}</Text>
        </View>
      ) : (
        <View style={s.mapPlaceholder}>
          <Text style={s.mapBig}>⏳</Text>
          <Text style={s.mapStatus}>Waiting for technician...</Text>
        </View>
      )}
...
const s = StyleSheet.create({
  ...
  mapPlaceholder: { height: 220, backgroundColor: '#1A3A6B', alignItems: 'center', justifyContent: 'center', gap: 10 },
  mapBig:         { fontSize: 60 },
  mapStatus:      { color: '#fff', fontSize: 16, fontWeight: '800' },
  mapEta:         { color: '#FF6B00', fontSize: 14, fontWeight: '700', backgroundColor: '#fff', paddingHorizontal: 15, paddingVertical: 6, borderRadius: 20 },
  content:        { padding: 15 },
